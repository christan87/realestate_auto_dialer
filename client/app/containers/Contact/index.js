        ...
        return(
            <div>
                <Row>
                    ...
                    <Col xs='12' md='6'>
                        <TwilioForm autoResponseEmail={autoResponseEmail} autoResponse={autoResponse} contact={contact} sendMessage={sendMessage} initiateCall={initiateCall} endCall={endCall} />
                    </Col>
                </Row>
